/*
  ...
  - Added the required column `time_end_start_in_minutes` to the `user_time_intervals` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_user_time_intervals" (
    ...
    "time_end_start_in_minutes" INTEGER NOT NULL,
